...
- Name: NavbarMenu UI interactions >> Navbar dropdown toggles visibility
- Location: /Users/kamil/Desktop/kjk-astro/tests/navigation.spec.ts:152:3
...
Locator: locator('.menu-container')
Expected: not visible
Received: visible
Call log:
  - expect.not.toBeVisible with timeout 5000ms
  - waiting for locator('.menu-container')
    9 × locator resolved to <div tabindex="0" aria-hidden="true" id="filter-sort-menu" class="menu-container">…</div>
      - unexpected value "visible"

    at /Users/kamil/Desktop/kjk-astro/tests/navigation.spec.ts:168:37
```
