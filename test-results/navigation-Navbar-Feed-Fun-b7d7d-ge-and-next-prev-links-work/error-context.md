...
- Name: Navbar & Feed Functionality >> Opening a post opens the correct page and next/prev links work
- Location: /Users/kamil/Desktop/kjk-astro/tests/navigation.spec.ts:57:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('h1') resolved to 3 elements:
    1) <h1>Audit</h1> aka locator('#header-left').getByText('Audit')
    2) <h1>No accessibility or performance issues detected.</h1> aka getByText('No accessibility or')
    3) <h1>…</h1> aka locator('h1').filter({ hasText: 'Settings' })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1')

    at /Users/kamil/Desktop/kjk-astro/tests/navigation.spec.ts:63:38
```
