...
function getThemeColors() {
  ...
  return {
    ...
    primaryColor: styles.getPropertyValue('--primary-color').trim() || 
      (isDarkMode ? defaultDarkTheme.primaryColor : defaultLightTheme.primaryColor),
    secondaryBgColor: styles.getPropertyValue('--secondary-bg').trim() || 
      (isDarkMode ? defaultDarkTheme.secondaryBgColor : defaultLightTheme.secondaryBgColor),
    ...
    cardBorderColor: styles.getPropertyValue('--card-border').trim() || 
      (isDarkMode ? defaultDarkTheme.cardBorderColor : defaultLightTheme.cardBorderColor),
...
function applyThemeToWindow(targetWindow) {
  ...
  try {
    targetWindow.dispatchEvent(new CustomEvent('themeChange', { detail: colors }));
  } catch (err) {
