...
async function debugCentering() {
  ...
  if (header) {
    ...
    console.log('  --content-max-width:', headerStyles.getPropertyValue('--content-max-width'));
    console.log('  --layout-max-width:', headerStyles.getPropertyValue('--layout-max-width'));
  }
  ...
  if (feed) {
    ...
    console.log('CSS Variables:');
    console.log('  --content-max-width:', feedStyles.getPropertyValue('--content-max-width'));
    console.log('  --layout-max-width:', feedStyles.getPropertyValue('--layout-max-width'));
  }
